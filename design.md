# System Design
_Generated: 2026-05-29 10:10_

## What This System Does

build me a top-down ultimate frisbee simulator. The user drags players to their starting stack location, then press a button to simulate who can catch the frisbee assuming all players are world-class level and smart.
...
## Reference Papers
- [An MIT thesis on a 3D Ultimate Frisbee simulator usable as a learning/coaching aid that models rules, offense, and defense.](https://dspace.mit.edu/bitstream/handle/1721.1/87375/53406384-MIT.pdf?sequence=2)
- [Sport-agnostic platform that converts player tracking into timing-aware spatial measures of "usable space" and off-ball opportunities for Ultimate, basketball, and soccer.](https://arxiv.org/abs/2603.06585)
- [Builds completion-percentage and field-value models from AUDL play-by-play data to identify optimal throw choices in Ultimate.](https://www.sloansportsconference.com/research-papers/a-machine-learning-approach-to-throw-value-estimation-in-professional-ultimate-frisbee)
- [Develops a zone-based state-transition model of AUDL possessions and identifies passing and turnover patterns that distinguish winning teams.](https://pmc.ncbi.nlm.nih.gov/articles/PMC8185146/)
- [Visual analytics system that simulates player behaviors under tactical configurations to support coach-facing scouting decisions.](https://ssxiexiao.github.io/papers/teamscouter.pdf)
- [Numerical simulation of frisbee flight using rigid-body dynamics and an experimental aerodynamic database.](https://www.researchgate.net/publication/377785910_Study_of_Frisbee_Flight_and_Rebound_Dynamics_Based_on_Frame_Conversion_and_Vector_Transformation)

## Implementation Notes
Built over 5 cycle(s). Final verdict: approve.
See `progress.md` for per-cycle details and `activity_log.md` for the full worker timeline.

## Getting Started

Run `bash run.sh` from this folder (WSL on Windows; bash on Linux/macOS). See `README.md` for further details.
